...
enlist_under_avg_income <- sum(enlist_by_income[which(enlist_by_income$avg_income < 
                             mean(enlist_by_income$avg_income)), "total_enlisted"])

enlist_under_avg_income / sum(enlist_by_income$total_enlisted)
```
