...
Find the average income for each zip code.
```{r}
# income_max <- income_analyze %>%
#  slice_max(n = 1, order_by = total_returns)
...
# enlist_by_income <- left_join(income_max, enlist_analyze, by='zip_prefix')
# head(enlist_by_income)
